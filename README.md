...
## Research Question
Given the past 10 years of data we want to data mine what effects song attributes (Danceability, Energy, Tempo, etc.) have on the popularity of a song that has been obtained from the US population. Can the song attributes predict whether it will be a Grammy award winner?
